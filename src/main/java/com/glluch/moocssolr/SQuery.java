...
public class SQuery {
    ...
    //TODO solve error 414
    protected int MAX_QUERY_LENGH=6200;//to avoid status: 414, message:Request-URI Too Long 	at org.apache.solr.client.solrj.impl.HttpSolrClient.executeMethod(HttpSolrClient.java:510)
